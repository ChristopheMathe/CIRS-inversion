...
!~ double precision, parameter :: spi=1./(dsqrt(4d+00*datan(1d+00)))
!~ double precision, parameter :: pi= 4d+00*datan(1d+00)
...
10  if(JU-JL.GT.1) then
        JM=(JU+JL)/2
        if((X(N).GT.X(1)).EQV.(A.GT.X(JM))) then
            JL=JM
        else
            JU=JM
        endif
...
ios1 = 0
open(50,file=filename,status='old',action='read',iostat=ios1)
...
integer :: ip = 0
integer :: is = 0
double precision :: x2 = 0.
double precision :: y2 = 0.
double precision :: x2y2 = 0.
...
integer :: N = 0
integer :: P = 0
double precision :: XN = 0.
double precision :: XI = 0.
double precision :: T = 0.
double precision :: TT
double precision :: A = 0.
double precision :: E = 0.
double precision :: X = 0.
double precision :: XPR = 0.
double precision :: TM = 0.
