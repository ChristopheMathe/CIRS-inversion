...
nsp,nb_kernel_t,f_kernel_t,corr_len_t,wei_t,file_prof_t,file_kernel_t)
...
namelist /input_inversion/    nb_df, df, nb_mol_inv, name_mol_inv, corr_len, wei, niter, iprint,&
...
!open(8, file=trim(filename_input), recl=80, delim='apostrophe')
