...
!~       Label 19: fr > f2
      if(ind.gt.nstep) goto 19
      if(ind.gt.nmax) goto 18
      if(ind.ge.(nstep-nmax+1)) goto 17
      if(ind.gt.1) goto 16
      n1=1
      n2=ind+nmax-1
      if(n1.le.n2) THEN
...
31    tauk(i)=tauk(i)+sr*vgt(nr,i+1-ind)
      n2=1
      do 32 i=n1-1,n2,-1
32    tauk(i)=tauk(i)+sr*vgt(nr,ind+1-i)
            goto 1
17    n1=ind
      n2=nstep
      do 33 i=n1,n2
33    tauk(i)=tauk(i)+sr*vgt(nr,i+1-ind)
      n2=1
      do 34 i=n1-1,n2,-1
...
18    n1=ind
      n2=nstep
      do 35 i=n1,n2
35    tauk(i)=tauk(i)+sr*vgt(nr,i+1-ind)
      n2=ind-nmax+1
      do 36 i=n1-1,n2,-1
36    tauk(i)=tauk(i)+sr*vgt(nr,ind+1-i)
            goto 1
19    n1=nstep
      n2=ind-nmax+1
      if(n1.ge.n2) THEN
    do 37 i=n1,n2,-1
37  tauk(i)=tauk(i)+sr*vgt(nr,ind+1-i)
        ELSE
    return
        ENDIF
1     continue
